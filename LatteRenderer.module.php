...
class LatteRenderer extends WireData implements Module, ConfigurableModule
{
   ...
   * 
   * This file routes all template rendering through the LatteRenderer module.
...
';
  ...
  public static function getModuleConfigInputfields(array $data)
  {
    ...
    $f->value =
      '<p>This module installs <strong>_latte.php</strong>, a ProcessWire template bridge. It routes all rendering to Latte and looks for <code>home.latte</code> instead of <code>home.php</code>.</p>' .
      ...
      '<p><br>You can override settings below or in <code>config.php</code>:</p>' .
      '<pre>$config->LatteRenderer = [' . "\n" .
      '  "layoutFile" => "layouts/custom.latte",' . "\n" .
      '  "templateDir" => "my-templates"' . "\n" .
      '];</pre>' .
      '<p>Absolute paths allowed.</p>' .
      '<p>Note: You have to install Latte via Composer <code>composer require nette/latte</code> for this module to work.</p>';
    $inputfields->add($f);
